  ...
  case 'linux':
    switch (arch) {
      ...
      case 'riscv64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'bun-crypto.linux-riscv64-musl.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./bun-crypto.linux-riscv64-musl.node')
            } else {
              nativeBinding = require('@cm-iv/bun-crypto-linux-riscv64-musl')
            }
          } catch (e) {
            loadError = e
          }
          ...
          localFileExisted = existsSync(
            join(__dirname, 'bun-crypto.linux-riscv64-gnu.node')
          )
          try {
            if (localFileExisted) {
              nativeBinding = require('./bun-crypto.linux-riscv64-gnu.node')
            } else {
              nativeBinding = require('@cm-iv/bun-crypto-linux-riscv64-gnu')
            }
          } catch (e) {
            loadError = e
          }
      ...
      case 's390x':
        localFileExisted = existsSync(
          join(__dirname, 'bun-crypto.linux-s390x-gnu.node')
        )
        try {
          if (localFileExisted) {
            nativeBinding = require('./bun-crypto.linux-s390x-gnu.node')
          } else {
            nativeBinding = require('@cm-iv/bun-crypto-linux-s390x-gnu')
          }
        } catch (e) {
          loadError = e
        }
